...
for(i in 1:n.nests){
  ...
  logit(gamma[i]) <- int.gam + eps.gam[year.rand[i]] + beta.gam.npgo * npgo.data[year[i]] #Unlike chla.R and sst.R, this can stay the same. See line 71
...
parameters<-c('eps.S', 'eps.gam', 'sigma.S', 'sigma.gam', 'beta.gam.npgo',
